...
PYTHONPATH=src python -m agent_runtime.cli.main sandbox conformance --backend docker --dry-run > .agent-runtime/test-report-2026-06-17/sandbox-conformance-docker.json
