...
- 修复 registered agent 并发运行时共享 runtime context 导致的 agent identity、capability、trace 和 session audit event 串线问题；普通 subprocess env allowlist 也会拒绝 secret-like key。
