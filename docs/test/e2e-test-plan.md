...
| P1 | REQ-E2E-X-010 approval provider approve/reject/timeout E2E | planned | planned | 后续补 approval matrix |
| P1 | REQ-E2E-X-011 concurrent audit/trace/observer E2E | planned | planned | 后续补并发 hash chain |
