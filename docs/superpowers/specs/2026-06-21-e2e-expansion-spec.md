...
关联文档：[docs/test/e2e-test-plan.md](../../../docs/test/e2e-test-plan.md)、[docs/reports/e2e-test-report.md](../../../docs/reports/e2e-test-report.md)、[docs/reports/test-report.md](../../../docs/reports/test-report.md)
...
| --- | --- | --- | --- |
| REQ-E2E-X-001 | E2E backlog 必须按 P0/P1/P2 分层，并写入 `docs/test/e2e-test-plan.md`。 | must | user |
...
| REQ-E2E-X-013 | 所有 E2E 结果必须更新 `docs/reports/e2e-test-report.md`，解释用例设计、命令、输出结果、输出解释和结论。 | must | QA |
...
- AC-E2E-X-001：`docs/test/e2e-test-plan.md` 增加 P0/P1/P2 matrix，并包含本 spec 的 requirement ID。
...
1. 扩展 `docs/test/e2e-test-plan.md`，新增 P0/P1/P2 backlog。
...
6. 更新 `docs/reports/e2e-test-report.md`，记录新增 P0 证据。
...
- P0 范围变化需要同步更新本 spec、`docs/test/e2e-test-plan.md` 和 `docs/reports/e2e-test-report.md`。
